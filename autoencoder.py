...
if __name__ == "__main__":
    ...
    kmeans = loadmodel(problem)
    if kmeans==None:
        # K-means Model
        kmeans = KMeans(n_clusters=num_classes, n_init=10, n_jobs=2, verbose=0)
    ...
    try:
        ...
        # K-means Model
        kmeans_ae = KMeans(n_clusters=num_classes, n_init=10, n_jobs=2, verbose=0)
